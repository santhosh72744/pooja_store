...
/>
  ...
  <div className="p-12 text-center animate-in fade-in duration-500">
    <h2 className="text-2xl font-serif text-[#0f172a] mb-4">
      Order Confirmed
    </h2>
    ...
    <button
      onClick={() => router.push('/')}
      className="px-10 py-4 bg-[#0f172a] text-white text-[11px] font-black uppercase tracking-[0.3em] rounded-xl hover:bg-[#c2410c] transition-all"
    >
      Continue Shopping
    </button>
  </div>
